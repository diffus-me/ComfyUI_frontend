...
function makeReachConcurrencyLimitMessage() {
  ...
  const max_concurrent_tasks = tierLimit.max_concurrent_tasks
...
const promptMessage = computed(() => {
  const needUpgrade = dialogStore.props.needUpgrade
  const upgradeReason = dialogStore.props.upgradeReason
  if (needUpgrade) {
